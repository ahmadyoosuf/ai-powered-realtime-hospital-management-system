  ...
  return (
    <Card className="card shadow-sm border-none">
      <CardHeader className="text-center py-16">
        ...
        <CardTitle className="font-bold text-2xl">Prescriptions</CardTitle>
        <CardDescription className="text-base mt-2">
          This feature is coming soon. You will be able to view and manage
          patient prescriptions from this page.
        </CardDescription>
      </CardHeader>
